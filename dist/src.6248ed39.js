...
var Header = function (_HTMLElement) {
  ...
  _createClass(Header, [{
    ...
    value: function render(title) {
      var component = (0, _litHtml.html)(_templateObject, title);
      (0, _litHtml.render)(component, this.shadow);
    }
  }, {
...
},{"lit-html":7}],2:[function(require,module,exports) {
'use strict';
...
customElements.define('app-header', _Header2.default);
...
//# sourceMappingURL=/src.6248ed39.map